...
use scryer_schema::{
    backed, cex_perp_funding_multi, cme_intraday_1m, dex_xstock_swaps, drift_liquidation, earnings, fluid_vault_config, fred_macro, fred_macro_extended, geckoterminal,
