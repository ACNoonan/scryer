...
| M3.4 | First workflow proof + soak | code-shipped 2026-05-02, data-pending — soak plist + protocol + integration tests landed; operator runs 24h parallel + 24h runner-only per `docs/m3_4_soak_protocol.md` to close | M3.3 |
